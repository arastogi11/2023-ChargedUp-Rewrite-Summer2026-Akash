 ...
 * to each mode, as described in the TimedRobot documentation. This project uses AdvantageKit
 * (LoggedRobot) so every input is logged and replayable.
 */
public class Robot extends LoggedRobot {
  ...
  public Robot() {
    ...
    switch (Constants.currentMode) {
      case REAL:
        // Running on a real robot, log to a USB stick ("/U/logs") and publish to NT
  ...
  public void teleopInit() {
    // Make sure the autonomous command stops when teleop starts.
    if (autonomousCommand != null) {
